...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _controllers_player_controller__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./controllers/player_controller */ \"./src/controllers/player_controller.js\");\n/* harmony import */ var _controllers_player_controller__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_controllers_player_controller__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _controllers_board_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controllers/board_controller */ \"./src/controllers/board_controller.js\");\n/* harmony import */ var _controllers_board_controller__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_controllers_board_controller__WEBPACK_IMPORTED_MODULE_2__);\n\n\n\n\nlet isPlayerTurn = true;\nlet player = (0,_controllers_player_controller__WEBPACK_IMPORTED_MODULE_1__.initPlayer)();\nlet computer = (0,_controllers_player_controller__WEBPACK_IMPORTED_MODULE_1__.initComputer)();\n(0,_controllers_board_controller__WEBPACK_IMPORTED_MODULE_2__.createBoard)(\"player\", player);\n(0,_controllers_board_controller__WEBPACK_IMPORTED_MODULE_2__.createBoard)(\"computer\", computer);\ndocument.getElementById(\"computer-board\").classList.add(\"selected-turn\");\n\nfunction switchTurn() {\n  isPlayerTurn = !isPlayerTurn;\n  if (isPlayerTurn) {\n    document.getElementById(\"computer-board\").classList.add(\"selected-turn\");\n    document.getElementById(\"player-board\").classList.remove(\"selected-turn\");\n  } else {\n    document.getElementById(\"player-board\").classList.add(\"selected-turn\");\n    document.getElementById(\"computer-board\").classList.remove(\"selected-turn\");\n  }\n  if (!isPlayerTurn) {\n    computer.attackWithAi(player.gameboard);\n    (0,_controllers_board_controller__WEBPACK_IMPORTED_MODULE_2__.updateComputerBoard)(player.gameboard.board);\n    switchTurn();\n  }\n}\n\nfunction addClickListener() {\n  const computerNodes = document.querySelectorAll(\".computer-board-node\");\n  computerNodes.forEach((node) => {\n    node.addEventListener(\"click\", () => {\n      const nodeIndex = node.dataset.index;\n      if (!node.classList.contains(\"selected\") && isPlayerTurn) {\n        node.classList.add(\"selected\");\n        if (computer.gameboard.board[nodeIndex].ship !== null) {\n          computer.gameboard.board[nodeIndex].isHit = true;\n          computer.gameboard.board[nodeIndex].ship.hit();\n          const computerHitNode = document.createElement(\"div\");\n          computerHitNode.classList.add(\"computer-hit-node\");\n          node.appendChild(computerHitNode);\n        } else {\n          computer.gameboard.board[nodeIndex].isMissed = true;\n          const computerMissedNode = document.createElement(\"div\");\n          computerMissedNode.classList.add(\"computer-missed-node\");\n          node.appendChild(computerMissedNode);\n          switchTurn();\n        }\n      }\n    });\n  });\n}\n\naddClickListener();\n\nconst resetButton = document.getElementById(\"start-button\");\nresetButton.addEventListener(\"click\", () => {\n  player = (0,_controllers_player_controller__WEBPACK_IMPORTED_MODULE_1__.initPlayer)();\n  computer = (0,_controllers_player_controller__WEBPACK_IMPORTED_MODULE_1__.initComputer)();\n  (0,_controllers_board_controller__WEBPACK_IMPORTED_MODULE_2__.createBoard)(\"player\", player);\n  (0,_controllers_board_controller__WEBPACK_IMPORTED_MODULE_2__.createBoard)(\"computer\", computer);\n  addClickListener();\n});\n\n\n//# sourceURL=webpack://webpack-template/./src/index.js?");
